...
class ModelToolImage extends Model {
  ...
  public function onesize($filename, $maxsize, $type = "") {
    ...
    $old_image = $filename;
    $new_image = 'cache/' . utf8_substr($filename, 0, utf8_strrpos($filename, '.')) . '-max-' . $maxsize . '.' . $extension;
  ...
  public function cropsize($filename, $width, $height, $type = "") {
    ...
    $old_image = $filename;
    $new_image = 'cache/' . utf8_substr($filename, 0, utf8_strrpos($filename, '.')) . '-cr-' . $width . 'x' . $height . $type .'.' . $extension;
