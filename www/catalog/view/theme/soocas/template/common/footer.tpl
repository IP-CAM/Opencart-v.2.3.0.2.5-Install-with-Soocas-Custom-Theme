  ...
  <div class="container footer__container">
    ...
    <div class="footer__content">
      ...
      <div class="footer__left">
        ...
        <? if ($categories) { ?>
          <?
          $menu_item_count = count($categories) + 1;
          $menu_first_items = $menu_item_count - (floor($menu_item_count / 2)) - 1;
          $menu_last_items = $menu_item_count - $menu_first_items - 1;
          ?>
          <nav class="footer-nav">
            <ul class="footer-nav__list">
              <? foreach (array_slice($categories, 0, $menu_first_items) as $category) { ?>
            ...
            <ul class="footer-nav__list">
              <? foreach (array_reverse(array_slice(array_reverse($categories), 0, $menu_last_items)) as $category) { ?>
                <li class="footer-nav__item">
                  <a href="<?= $category['href']; ?>" class="footer-nav__link">
                    <?= $category['name']; ?>
                  </a>
      ...
      <div class="footer__right">
        ...
        <div class="footer__links">
          <a class="footer__link" href="https://www.facebook.com/soocasrussia/" aria-label="Soocas в facebook">
          ...
          <a class="footer__link" href="https://www.youtube.com/" aria-label="Soocas в youtube">
          ...
          <a class="footer__link" href="https://www.instagram.com/soocasrussia/" aria-label="Soocas в instagram">
            <svg class="footer__icon" viewBox="0 0 20 20">
    ...
    <p class="footer__copyright">
      © COPYRIGHT 2021 SOOCAS. ALL RIGHTS RESERVED
    </p>
