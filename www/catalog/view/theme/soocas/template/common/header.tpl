      ...
      <div class="container header__container">
        <div class="panel">
          <a href="./category.html" class="panel__link">
            ...
            <img class="panel__arrow" src="catalog/view/theme/soocas/images/dist/header/arrow-link.svg" alt="Soocas logo" width="18" height="10">
          </a>
        </div>
        <div class="header__info">
          ...
          <div class="header__buttons">
            <button class="header__btn header__btn_cart" aria-label="Корзина">
              ...
              <span class="header__cart-num header__cart-num_active">1</span>
            </button>
